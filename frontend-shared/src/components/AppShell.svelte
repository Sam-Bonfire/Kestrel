...
<div class="flex h-screen w-screen overflow-hidden bg-[var(--color-canvas-base)] relative">
  ...
  <!-- Sidebar Container -->
  <div class="no-print fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 lg:transform-none lg:relative lg:translate-x-0 {isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} shadow-2xl lg:shadow-none">
    {@render sidebar?.()}
  </div>
