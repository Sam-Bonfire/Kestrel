...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            // System tray (v1): desktop-only; tauri menu/tray APIs do not
            // exist on mobile targets. Left-click toggle is
            // Windows/macOS-only (unsupported on libappindicator Linux);
